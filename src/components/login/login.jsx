            ...
            <div className='login-content'>
                ...
                <form action="" onSubmit={handleSubmit}>
                    <div className="input-box">
                        <input type="text" placeholder='  Username or Email' ref={userRef} style={{width:'350px',height:'40px',fontFamily:'Poppins-Thin'}} required />
                    </div>
                    <div className="input-box">
                        <input type="password" placeholder='  Password' ref={passRef} style={{width:'350px',height:'40px',fontFamily:'Poppins-Thin'}} required />
                    </div>
                    <div >
